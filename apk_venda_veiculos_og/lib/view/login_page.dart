                      ...
                      children: [
                        ...
                        TextButton(
                          onPressed: _loading ? null : () {
                            // If the app has a registration flow, navigate to it. For now just show a message.
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Registro não implementado')));
                          },
